...
```
cd existing_repo
git remote add origin https://gitlab.com/amenallah.benkhalifa/packer-vmware.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/amenallah.benkhalifa/packer-vmware/-/settings/integrations)
...
>>>>>>> 6d3d2b691fa3fe8ecd34b84d0e4ee5ef1368eac1
